...
public class driveTrain extends Subsystem {
    ...
    public void liftToHeight(int position) {
        // Translate to encoder unites - need double, how will translate
        double encoderPosition=10 * position;
        System.out.println("lift to height " + encoderPosition);
        motorLiftStatge.set(ControlMode.MotionMagic, encoderPosition);
    }
    ...
    private void motorConfig() {
       ...
       System.out.println("Bonjour");
        ...
        motorLiftStatge.configContinuousCurrentLimit(RobotMap.kLiftStage1ContinuousCurrentLimit, RobotMap.kTimeoutMs);
